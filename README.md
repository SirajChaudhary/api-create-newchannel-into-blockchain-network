...
#### Note : In my case I have created a channel for test-network which is at path /home/ubuntu/fabric-samples/test-network. Please modify this input param as per your network path.
